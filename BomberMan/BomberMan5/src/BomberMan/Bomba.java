...
{	
	...
	public Atesle atesle=null;			// Bombaya patlama efekti vermek için
	
	public Image bombaResim[];			// Bomba resmini animasyon olarak gösterebilmek için (2 resim kullanıyoruz) 
	...
	public  void run()
        {  
		 ...
		 atesle=new Atesle(oyun,this,oyuncu);                           // ates efekti ver		 
	}
	...
	public  void paint(Graphics g)
		...
		if(atesle!=null)
			atesle.paint(g);					// bomba patlamış ise oluşan bomba nesnesinin ates efetini ver
	}
}
